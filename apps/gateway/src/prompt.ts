...
export function buildPrompt(
  ...
  const lines: string[] = [
    ...
    '- Commit all your work. Use the commit message convention documented in the repository CLAUDE.md;',
    '  if none is documented, match the style of the recent `git log` entries. Do not assume Conventional',
    '  Commits — many repositories reject the feat:/fix:/chore: prefixes outright.',
